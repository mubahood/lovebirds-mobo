...
class _MatchesScreenState extends State<MatchesScreen>
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            ...
                            SizedBox(width: 15),
                            _buildHeaderAction(Icons.favorite_border_rounded, 'Likes'),
                            SizedBox(width: 15),
                            _buildHeaderAction(Icons.chat_bubble_outline_rounded, 'Chats'),
                          ],
                        ),
                      ],
                    ),
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        return AnimatedBuilder(
          ...
          builder: (context, child) {
            return Transform.translate(
              offset: Offset(0, 50 * (1 - _cardAnimations[animationIndex].value)),
              child: Transform.scale(
                scale: 0.9 + (0.1 * _cardAnimations[animationIndex].value),
                child: Opacity(
                  opacity: _cardAnimations[animationIndex].value,
                  child: _buildRevolutionaryMatchCard(_filteredMatches[index], index),
                ),
              ),
            );
          },
                      ...
                      children: [
                        Row(
                          children: [
                            ...
                            _buildCompatibilityChip(match.compatibilityScore.toInt(), gradient),
                          ],
                        ),
                        SizedBox(height: 8),
                        Text(
  ...
  Widget _buildActionButton(IconData icon, List<Color> gradient, VoidCallback onTap) {
    return GestureDetector(
      onTap: () {
        HapticFeedback.lightImpact();
        onTap();
      ...
      builder: (context) => Container(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 25),
            ...[
              {'icon': Icons.chat_rounded, 'title': 'Send Message', 'color': Color(0xFF667eea)},
              {'icon': Icons.card_giftcard_rounded, 'title': 'Send Gift', 'color': Color(0xFFf093fb)},
              {'icon': Icons.calendar_today_rounded, 'title': 'Plan Date', 'color': Color(0xFF4facfe)},
              {'icon': Icons.shopping_cart_rounded, 'title': 'Shop Together', 'color': Color(0xFF89f7fe)},
            ].map((item) {
              return Container(
                ...
                child: ListTile(
                  ...
                  trailing: Icon(Icons.arrow_forward_ios_rounded, color: Colors.grey[500], size: 16),
                  onTap: () {
