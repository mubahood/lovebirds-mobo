...
class _CheckoutScreenState extends State<CheckoutScreen>
  ...
  String _getDeliveryEstimate() {
    ...
    return 'Expected delivery by ${weekdays[deliveryDate.weekday - 1]}, ${months[deliveryDate.month - 1]} ${deliveryDate.day}';
  }
  ...
  void _handlePaymentSuccess(Map<String, dynamic> paymentResult) {
    ...
    _showOrderSuccessDialog(paymentResult);
  }
