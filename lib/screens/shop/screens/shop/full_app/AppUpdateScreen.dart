...
import 'package:lovebirds_app/utils/CustomTheme.dart'; // Your theme colors
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        systemOverlayStyle: SystemUiOverlayStyle.light.copyWith(
          ...
          systemNavigationBarColor: _primaryColor.withValues(alpha: 0.8),
  ...
  Widget _buildBackground() {
    ...
    return Positioned.fill(
      child: Image.asset(
        ...
        fit: BoxFit.cover,
        color: Colors.black.withValues(alpha: 0.1), // Optional darkening
    ...
    return ClipRRect(
      ...
      child: BackdropFilter(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            color: Colors.white.withValues(alpha: 0.1), // Glass background color
            borderRadius: BorderRadius.circular(25),
            border: Border.all(
                color: Colors.white.withValues(alpha: 0.15)), // Glass border
          ),
          child: child,
        ),
      ),
