...
class FullAppController extends FxController {
  ...
  FullAppController(this.tickerProvider) {
    navItems = [
      NavItem('DISCOVER'.toUpperCase(), FeatherIcons.heart),
      NavItem('MATCHES'.toUpperCase(), FeatherIcons.users),
      NavItem('MARKETPLACE'.toUpperCase(), FeatherIcons.shoppingCart),
      NavItem('MESSAGES'.toUpperCase(), FeatherIcons.messageCircle),
      NavItem('PROFILE'.toUpperCase(), FeatherIcons.user),
    ];
